...
options = {
  ...
  use_odometry = false,
  use_nav_sat = false,
  use_position_sensor = true, -- use POZYX
...
TRAJECTORY_BUILDER.collate_fixed_frame = false -- test this

TRAJECTORY_BUILDER_3D.num_accumulated_range_data = 1
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.translation_weight = 4 -- 4 -- 8 --5.5
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.translation_weight_z = 4 -- 4 -- 8 --5.5
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.rotation_weight = 150 -- 4 -- 8 -- 5
...
MAP_BUILDER.num_background_threads = 3 -- default 3
POSE_GRAPH.optimization_problem.huber_scale =  1 -- 5e2
POSE_GRAPH.optimize_every_n_nodes = 320 --480
POSE_GRAPH.constraint_builder.sampling_ratio = 0.15 -- less = faster algo default 0.3
POSE_GRAPH.constraint_builder.max_constraint_distance = 15 -- default 15
POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 25  -- default 50
POSE_GRAPH.constraint_builder.min_score = 0.55  -- default 0.55
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.66    -- og 0.6
POSE_GRAPH.optimization_problem.rotation_weight = 0
POSE_GRAPH.optimization_problem.acceleration_weight = 1e2
-- ovi dolje su og 10
POSE_GRAPH.constraint_builder.ceres_scan_matcher_3d.translation_weight = 5
POSE_GRAPH.constraint_builder.ceres_scan_matcher_3d.translation_weight_z = 5
POSE_GRAPH.constraint_builder.ceres_scan_matcher_3d.rotation_weight = 5
POSE_GRAPH.optimization_problem.nav_sat_huber_scale = 0
